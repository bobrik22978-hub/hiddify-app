...
import com.bobrvpn.app.Application
import com.bobrvpn.app.MainActivity
import com.bobrvpn.app.R
import com.bobrvpn.app.Settings
import com.bobrvpn.app.constant.Action
import com.bobrvpn.app.constant.Status
//import com.bobrvpn.app.utils.CommandClient
import com.hiddify.core.libbox.Libbox
import com.bobrvpn.app.Application.Companion.notification
import com.bobrvpn.app.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "bobrvpn service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "Bobrvpn")
